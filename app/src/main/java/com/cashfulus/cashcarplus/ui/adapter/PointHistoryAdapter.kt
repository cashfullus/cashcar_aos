...
class PointHistoryAdapter(private val context: Context, private val dataList: ArrayList<TmpData>) : RecyclerView.Adapter<PointHistoryAdapter.Holder>() {
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.tvRegister.text = dataList[position].register
...
data class TmpData(val title: String, val register: String, val point: Int)